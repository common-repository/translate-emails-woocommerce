...
namespace ShopMagicMultilingualVendor\WPDesk\PluginBuilder\Builder;

use ShopMagicMultilingualVendor\WPDesk\PluginBuilder\Plugin\AbstractPlugin;
use ShopMagicMultilingualVendor\WPDesk\PluginBuilder\Plugin\ActivationAware;
use ShopMagicMultilingualVendor\WPDesk\PluginBuilder\Storage\PluginStorage;
/**
 ...
 */
class InfoActivationBuilder extends \ShopMagicMultilingualVendor\WPDesk\PluginBuilder\Builder\AbstractBuilder
{
     ...
     */
    public function __construct(\ShopMagicMultilingualVendor\WPDesk_Buildable $info, $is_active)
    {
        $this->info = $info;
    ...
    public function build_plugin()
    {
        ...
        if ($this->plugin instanceof \ShopMagicMultilingualVendor\WPDesk\PluginBuilder\Plugin\ActivationAware && $this->is_active) {
            $this->plugin->set_active();
        }
        return $this->plugin;
    }
    public function store_plugin(\ShopMagicMultilingualVendor\WPDesk\PluginBuilder\Storage\PluginStorage $storage)
    {
