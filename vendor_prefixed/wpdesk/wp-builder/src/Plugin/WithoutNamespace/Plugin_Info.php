...
if (!\interface_exists('ShopMagicMultilingualVendor\\WPDesk_Translatable')) {
    require_once __DIR__ . '/Translatable.php';
}
if (!\interface_exists('ShopMagicMultilingualVendor\\WPDesk_Buildable')) {
    require_once __DIR__ . '/Buildable.php';
}
if (!\interface_exists('ShopMagicMultilingualVendor\\WPDesk_Has_Plugin_Info')) {
 ...
 */
class WPDesk_Plugin_Info implements \ShopMagicMultilingualVendor\WPDesk_Translatable, \ShopMagicMultilingualVendor\WPDesk_Buildable, \ShopMagicMultilingualVendor\WPDesk_Has_Plugin_Info
{
    /** @var string */
