...
if (!\class_exists('ShopMagicMultilingualVendor\\Basic_Requirement_Checker')) {
    require_once 'Basic_Requirement_Checker.php';
}
if (!\class_exists('ShopMagicMultilingualVendor\\WPDesk_Basic_Requirement_Checker_With_Update_Disable')) {
...
{
    const LIBRARY_TEXT_DOMAIN = 'translate-emails-woocommerce';
    /**
    ...
    {
        return new \ShopMagicMultilingualVendor\WPDesk_Basic_Requirement_Checker($plugin_file, $plugin_name, $text_domain, null, null);
    }
    /**
    ...
    {
        $requirements_checker = new \ShopMagicMultilingualVendor\WPDesk_Basic_Requirement_Checker_With_Update_Disable($plugin_file, $plugin_name, $text_domain, $requirements['php'], $requirements['wp']);
