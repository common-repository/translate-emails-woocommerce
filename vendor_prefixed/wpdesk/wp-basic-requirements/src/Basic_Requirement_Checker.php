...
if (!\interface_exists('ShopMagicMultilingualVendor\\WPDesk_Requirement_Checker')) {
...
if (!\class_exists('ShopMagicMultilingualVendor\\WPDesk_Basic_Requirement_Checker')) {
     ...
     */
    class WPDesk_Basic_Requirement_Checker implements \ShopMagicMultilingualVendor\WPDesk_Requirement_Checker
    {
