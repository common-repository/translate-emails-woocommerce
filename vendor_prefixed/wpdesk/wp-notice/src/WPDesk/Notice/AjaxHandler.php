...
namespace ShopMagicMultilingualVendor\WPDesk\Notice;

use ShopMagicMultilingualVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant;
use ShopMagicMultilingualVendor\WPDesk\PluginBuilder\Plugin\PluginAccess;
/**
 * Class AjaxHandler
 *
 ...
 */
class AjaxHandler implements \ShopMagicMultilingualVendor\WPDesk\PluginBuilder\Plugin\HookablePluginDependant
{
    use PluginAccess;
    ...
    public function processAjaxNoticeDismiss()
    {
        if (isset($_POST[self::POST_FIELD_NOTICE_NAME])) {
            ...
            \update_option(\ShopMagicMultilingualVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_NAME_PREFIX . $noticeName, \ShopMagicMultilingualVendor\WPDesk\Notice\PermanentDismissibleNotice::OPTION_VALUE_DISMISSED);
